...
Something else I found interesting was how their CAI models could be overtrained, resulting in boilerplate phrases like "you are valid, valued, and cared for," which I thought was a humorous instance of Goodhart's law. They found that smoothing out labels and ensembling labels generated from the constitutional principles (as they prompted their models with one principle at a time, which I glossed over). 

They also found that their RLAIF model was "virtually never evasive," which is definitely not my experience with Anthropic's models. Of course, the constitutional principles chosen and the fine-tuning done in practice are probably quite different, but I was surprised to hear that evasive behavior from LLMs does not need to be come at a significant decrease in helpfulness. Intuitively, you would think that an intelligent enough system would be able to provide a nuanced (and helpful) response to any sort of prompt, whether prompt is harm-eliciting or not, and it seems like this is true. 
